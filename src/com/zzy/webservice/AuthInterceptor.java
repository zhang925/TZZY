...
public class AuthInterceptor {// implements HandlerInterceptor
	...
	public boolean isHandle(HttpServletRequest request){
		...
		List<Map<String, Object>> list = null;//systemService.findForJdbc(" select authority_uri from t_s_authority_white ");
		boolean flag = false;
...
//					}
	...
	private boolean isAjax(HttpServletRequest request, HttpServletResponse response){
		return true;//oConvertUtils.isNotEmpty(request.getHeader("X-Requested-With"));
	}
