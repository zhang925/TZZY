...
<script type="text/javascript">
		$(function(){
			var load = "${load}";
			if(load=="see"){//查看
				$("[tt='city']").attr("disabled","disabled");
			}else if(load=="upt"){//修改
		...
		<table >
			<tr id="firsttr">
				...
				<td>
					...
					<input  id="id" name="id" tt="city"  value="${city.id }"   />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input  id="code" name="code" value="${city.code }" tt="city" class="easyui-validatebox"  data-options="required:true,validType:'minLength[1,20]'"  />
				</td>
			</tr>
			<tr>
				<td align="right">*市区名称：</td>
				<td>
					<input  id="name" name="name" value="${city.name }" tt="city" class="easyui-validatebox"  data-options="required:true,validType:'minLength[1,20]'"  />
				</td>
			</tr>
			<tr>
				<td align="right">*省编码：</td>
				<td>
					<input id="provincecode" name="provincecode" value="${city.provincecode }" tt="city"  class="easyui-validatebox" data-options="required:true,validType:'minLength[1,20]'"  />
				</td>
			</tr>
			<tr>
				<td align="right">*状态：</td>
				<td>
					<input id="state" name="state" value="${city.state }" tt="city"   />
				</td>
			</tr>
