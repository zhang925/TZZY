	...
	<form id="ff" method="post">
		<table >
			...
			<tr>
				...
				<td>
					<input id="sex" name="sex"  type="radio" value="男" <c:if test="${user.sex=='男'}">checked="checked"</c:if> />男&nbsp;
					<input id="sex" name="sex"  type="radio" value="女" <c:if test="${user.sex=='女'}">checked="checked"</c:if> />女&nbsp;
					<input id="sex" name="sex"  type="radio" value="保密" <c:if test="${user.sex=='保密'}">checked="checked"</c:if>  />保密
				</td>
			</tr>
			<tr>
