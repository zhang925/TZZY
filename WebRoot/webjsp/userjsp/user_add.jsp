	...
	<form id="ff" method="post">
		<table >
			<tr>
				...
				<td>
					<input  id="username" name="username" class="easyui-validatebox"  data-options="required:true,validType:'minLength[1,20]'"  />
				</td>
			</tr>
			<tr>
			...
			<tr align="center">
				<td colspan="2">
					<a id="save" class="easyui-linkbutton" data-options="iconCls:'icon-add'">保存</a>
					&nbsp;&nbsp;  
