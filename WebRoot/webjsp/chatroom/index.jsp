...
<body>
	...
	<form name="form1" method="post" action="../../Messages?action=loginRoom" onSubmit="return check()">
		...
		background="../../images/chatroom/login.jpg">
			<tr>
			...
			<tr>
				...
				<td width="94" valign="top" class="word_dark">
					<input name="Submit" type="submit" class="btn_bg" value="进 入"></td>
			</tr>
			<!--<tr>
				<td width="53" align="center" valign="top" class="word_dark">&nbsp;</td>
				 <td width="216" align="center" valign="top" class="word_dark">密码：
					<input type="password" name="userpwd" class="login">
				</td> 
				<td></td>
				<td width="94" valign="top" class="word_dark">
					<input name="Submit" type="submit" class="btn_bg" value="进 入"></td>
