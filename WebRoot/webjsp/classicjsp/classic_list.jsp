...
<script type="text/javascript">
		$(function(){
			 $("#t_classic").datagrid({
				...
				width:1000,
				height:400,
				url:'classicController/Classiclist.do',
				//是否显示斑马线效果。
				striped:true,
				...
				toolbar: [{
					...
					handler: function(){
						...
						handler: function(){
							//允许多行选中(但只能选中一条)
						    var ids = [];
						    var rows = $('#t_classic').datagrid('getSelections');
			...
			//按钮
			  ...
			  //设置分页控件  
		    var p = $('#t_classic').datagrid('getPager'); 
		    $(p).pagination({  
			         ...
			         $.ajax({
			        	...
			        	success:function(data){
			        		...
			        		if(data.message=="success"){
			        			...
			        			$('#t_classic').datagrid('load',{});//刷新页面数据
			        		}else{
