...
<style type="text/css">
	.table{width:500px;border:0px;border-collapse:collapse;border-spacing:0;}
    .tr{height:30px;}
...
<script type="text/javascript">
		...
		function loadgroup(typeid){
			$.ajax({
				url:"txlController/txlbygroup.do?typeid="+typeid,
				type:"POST",
				data:"",
				dataType:"json",
				success:function(data){
					var html01 = "<table class=\"table\"><tr align=\"center\" class=\"tr\"><td class=\"td\">姓名</td><td class=\"td\">邮箱</td><td class=\"td\">电话</td></tr></table>";
					...
					for(var i=0;i<txllist.length;i++){
						...
						html = html + "<table class=\"table\"><tr align=\"center\" class=\"tr\" ><td class=\"td\">"+txllist[i].name+"</td><td class=\"td\">"+txllist[i].email+"</td><td class=\"td\">"+txllist[i].phone+"</td></tr></table>"
					}
					$("#txl01").append(html01 + html);
				}
			});
		}
